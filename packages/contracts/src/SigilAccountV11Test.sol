 ...
 */
contract SigilAccountV11Test is BaseAccount, Initializable, ReentrancyGuard, UUPSUpgradeable, IERC1271, IERC165 {
    ...
    mapping(address => bool) public allowedERC1271Callers; // V11: scoped agent ERC-1271
    ...
    function _isAuthorizedSigner(address signer) internal view returns (bool) {
        ...
        // V11: Scoped ERC-1271 — agent key allowed ONLY for whitelisted protocol callers.
