...
import "./SigilAccountV12.sol";

/**
 * @title SigilAccountV12Factory
 ...
 */
contract SigilAccountV12Factory is Ownable2Step, ReentrancyGuard {
    SigilAccountV12 public immutable accountImplementation;
    ...
    constructor(IEntryPoint entryPoint_, address treasury_, uint256 deployFee_) Ownable(msg.sender) {
        ...
        accountImplementation = new SigilAccountV12(entryPoint_, address(this));
    }
    ...
    function createAccount(
        ...
        uint256 salt
    ) external payable returns (SigilAccountV12 account) {
    ...
    function _createAccount(
        ...
        uint256 ownerTransferDelay_,
        uint256 salt
    ) internal returns (SigilAccountV12 account) {
        // ── Fee check ──
