 ...
 */
contract SigilAccountV12 is BaseAccount, Initializable, ReentrancyGuard, UUPSUpgradeable, IERC1271, IERC165 {
    ...
    event ERC1271CallerUpdated(address indexed caller, bool allowed); // V12
    ...
    // ─── V12: Scoped ERC-1271 (appended to preserve V10 storage layout) ───
    mapping(address => bool) public allowedERC1271Callers;
    uint256[46] private __gap_upgrade;      // 50 - 3 used - 1 V12 (pendingImplementation, upgradeRequestedAt, _upgradeAuthorized, allowedERC1271Callers)
