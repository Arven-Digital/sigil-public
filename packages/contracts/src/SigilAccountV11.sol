 ...
 */
contract SigilAccountV11 is BaseAccount, Initializable, ReentrancyGuard, UUPSUpgradeable, IERC1271, IERC165 {
    ...
    event ERC1271CallerUpdated(address indexed caller, bool allowed); // V11
    ...
    function _isAuthorizedSigner(address signer) internal view returns (bool) {
        ...
        // V11: Agent key valid only when caller is whitelisted and account not frozen
    ...
    // ─── V11: Scoped ERC-1271 (appended to preserve V10 storage layout) ───
    mapping(address => bool) public allowedERC1271Callers;
    uint256[46] private __gap_upgrade;      // 50 - 3 used - 1 V11 (pendingImplementation, upgradeRequestedAt, _upgradeAuthorized, allowedERC1271Callers)
