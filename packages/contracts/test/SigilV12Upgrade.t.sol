...
/// @notice Test V12 scoped ERC-1271 logic
contract SigilV12UpgradeTest is Test {
    ...
    SigilAccountV12 v11impl;
    address owner;

    function setUp() public {
        owner = address(this);
        v11impl = new SigilAccountV12(IEntryPoint(ENTRYPOINT), address(this));
    }

    function _deployAccount() internal returns (SigilAccountV12) {
    ...
    function test_V12Compiles() public view {
